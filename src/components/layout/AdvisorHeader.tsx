...
import { Menu, X, Home, BookOpen, Headphones, ExternalLink, User, LogOut, ArrowLeft } from 'lucide-react';
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link
            to="/"
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-gray-700 hover:text-brand hover:bg-brand/5 transition-all duration-200 font-medium"
          >
